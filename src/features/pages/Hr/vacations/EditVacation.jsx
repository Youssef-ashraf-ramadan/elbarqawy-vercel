...
import { getLeaveTypeDetails, updateLeaveType, clearError, clearSuccess } from '../../../../redux/Slices/authSlice';
...
const EditVacation = () => {
  ...
  useEffect(() => {
    if (leaveTypeDetails) {
      setFormData({
        name_en: leaveTypeDetails.name_en || leaveTypeDetails.name || '',
        name_ar: leaveTypeDetails.name_ar || leaveTypeDetails.name || '',
        default_balance: leaveTypeDetails.default_balance || ''
      });
    }
  }, [leaveTypeDetails]);
  ...
  const handleSubmit = async (e) => {
    ...
    await dispatch(updateLeaveType({ id, leaveTypeData: submitData }));
  };
