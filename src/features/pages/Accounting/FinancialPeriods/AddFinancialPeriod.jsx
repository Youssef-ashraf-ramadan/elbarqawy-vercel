...
import { addFinancialPeriod, clearError, clearSuccess } from '../../../../redux/Slices/authSlice';

const statusOptions = ['Open', 'Closed', 'Pending'];

const AddFinancialPeriod = () => {
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(addFinancialPeriod(formData));
  };
  ...
  return (
    ...
    >
      <div style={{ marginBottom: '30px', maxWidth: '900px', marginInline: 'auto' }}>
        ...
        <h1 style={{ fontSize: '24px', fontWeight: 'bold', margin: 0 }}>إضافة فترة مالية جديدة</h1>
      </div>
