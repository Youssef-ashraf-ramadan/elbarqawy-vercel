...
import { addSafe, clearError, clearSuccess } from '../../../../redux/Slices/authSlice';
  ...
  return (
    <div style={{ 
      ...
      <div style={{ marginBottom: '30px' }}>
        ...
        <h1 style={{ fontSize: '24px', fontWeight: 'bold', margin: 0 }}>إضافة خزنة جديدة</h1>
      </div>
