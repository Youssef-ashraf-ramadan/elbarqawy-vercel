...
import { addCurrency, clearError, clearSuccess } from '../../../../redux/Slices/authSlice';
...
const AddCurrency = () => {
  ...
  return (
    <div style={{ padding: '30px', backgroundColor: '#121828', minHeight: 'calc(100vh - 80px)', color: 'white', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      <h1 style={{ fontSize: '24px', marginBottom: '30px' }}>إضافة عملة جديدة</h1>
